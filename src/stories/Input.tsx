...
export const Input = ({ label, type, clearable, ...props }: InputProps) => {
  ...
  return (
    <label className="box__input ">
      ...
      <input
        className={["input", `input__${type}`].join(" ")}
        value={value}
        type={currentType}
        {...props}
